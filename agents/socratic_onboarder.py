...
if "src" in _current_file.parts:
    # soul-ledger: /src/public/agents/socratic_onboarder.py -> 3 parents up to /src, then 1 more to root
    PROJECT_ROOT = _current_file.parent.parent.parent.parent
else:
    # deep-pulse: /agents/socratic_onboarder.py -> 2 parents up to root
    PROJECT_ROOT = _current_file.parent.parent

# Inject public root into path so 'core.xxx' imports work in soul-ledger
if "src" in _current_file.parts:
    import sys
