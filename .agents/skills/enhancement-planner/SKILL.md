...
4. **Sprint Synthesis**
   ...
   - Populate the file according to the `sprint-template.md` in `.agents/rules/`.
...
## Sprint Format
Refer to `.agents/rules/sprint-template.md` for the exact structure to use for new sprint files.
