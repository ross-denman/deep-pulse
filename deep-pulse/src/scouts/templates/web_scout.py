...
class WebScout(BaseScout):
    ...
    async def discover(self, params: Dict[str, Any]) -> str:
        ...
        try:
            async with AsyncWebCrawler(config=browser_cfg) as crawler:
                ...
                return {"markdown": result.markdown, "status_code": result.status_code if hasattr(result, "status_code") else 200, "error": None}
    ...
    async def extract(self, raw_data: Any, distiller: Dict[str, Any], keywords: List[str] = None) -> Dict[str, Any]:
        ...
        # Tier 0: Local SLM Sieve
        logger.info(f"Tier 0: Distilling via {distiller['model']}...")
