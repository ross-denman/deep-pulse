...
if "src" in _current_file.parts:
    # soul-ledger: /src/public/storage/state_machine.py -> 3 parents up
    PROJECT_ROOT = _current_file.parent.parent.parent.parent
else:
    # deep-pulse: /storage/state_machine.py -> 2 parents up
    PROJECT_ROOT = _current_file.parent.parent

DB_PATH = PROJECT_ROOT / "harvest" / "mesh_state.db"
...
# Treasury remains in notary/core for sovereign key protection
from src.notary.core.treasury import Treasury

class MeshStateMachine:
    """
    The Orchestrator of State for the Discovery Mesh.
